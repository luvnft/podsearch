<template>
  <NuxtLink :to="props.link" class="tw-flex tw-flex-col tw-justify-center tw-gap-1 tw-text-gray-600 tw-no-underline tw-w-full tw-h-full">
    <button
      type="button"
      title="homeButton"
      class="tw-flex items-center font-medium tw-group tw-flex-col tw-items-center tw-justify-center tw-rounded-md tw-border tw-border-gray-200 tw-bg-gray-50 tw-fill-gray-400 tw-p-2 tw-shadow hover:tw-bg-gray-100 active:tw-shadow-sm"
    >
