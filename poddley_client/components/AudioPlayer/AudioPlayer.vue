  ...
  <div class="bg-white border-gray-200 fixed bottom-0 left-0 z-50 grid h-24 w-full grid-cols-1 border-t px-8 md:grid-cols-3">
      ...
      <div class="w-full">
        <div class="mx-auto mb-1 flex items-center justify-center">
          <button data-tooltip-target="tooltip-shuffle" type="button" class="group mr-1 rounded-full p-2.5 hover:bg-gray-100 focus:ring-gray-200 focus:outline-none focus:ring-4">
            <svg class="text-gray-500 h-4 w-4 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
          ...
          <div
            id="tooltip-shuffle"
            role="tooltip"
            class="tooltip text-white bg-gray-900 invisible absolute z-10 inline-block rounded-lg px-3 py-2 text-sm font-medium opacity-0 shadow-sm transition-opacity duration-300"
          >
            Shuffle video
          ...
          <button data-tooltip-target="tooltip-previous" type="button" class="group rounded-full p-2.5 hover:bg-gray-100 focus:ring-gray-200 focus:outline-none focus:ring-4">
            <svg class="text-gray-500 h-4 w-4 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 12 16">
              <path
          ...
          <button
            ...
            type="button"
            class="group bg-blue-500 mx-2 inline-flex items-center justify-center rounded-full p-2.5 font-medium hover:bg-blue-700 focus:ring-blue-300 focus:outline-none focus:ring-4"
          >
          ...
          <button data-tooltip-target="tooltip-restart" type="button" class="group mr-1 rounded-full p-2.5 hover:bg-gray-100 focus:ring-gray-200 focus:outline-none focus:ring-4">
            <svg class="text-gray-500 h-4 w-4 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
    ...
    <div class="ml-auto hidden items-center justify-center md:flex">
      <button data-tooltip-target="tooltip-playlist" type="button" class="group mr-1 rounded-full p-2.5 hover:bg-gray-100 focus:ring-gray-200 focus:outline-none focus:ring-4">
        <svg class="text-gray-500 h-4 w-4 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 16">
          <path
      ...
      <button data-tooltip-target="tooltip-captions" type="button" class="group mr-1 rounded-full p-2.5 hover:bg-gray-100 focus:ring-gray-200 focus:outline-none focus:ring-4">
        <svg class="text-gray-500 h-4 w-4 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
          <path
      ...
      <button data-tooltip-target="tooltip-expand" type="button" class="group mr-1 rounded-full p-2.5 hover:bg-gray-100 focus:ring-gray-200 focus:outline-none focus:ring-4">
        <svg class="text-gray-500 h-4 w-4 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
          <path
      ...
      <button data-tooltip-target="tooltip-volume" type="button" class="group rounded-full p-2.5 hover:bg-gray-100 focus:ring-gray-200 focus:outline-none focus:ring-4">
        <svg class="text-gray-500 h-4 w-4 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
          <path
