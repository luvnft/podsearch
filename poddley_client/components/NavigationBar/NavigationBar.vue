<template>
  <div class="tw-flex tw-h-20 tw-w-full tw-gap-2 tw-pb-4 tw-text-lg tw-font-semibold tw-text-gray-500">
    <ButtonsNewButton class="tw-border tw-w-1/2 tw-border-solid tw-border-gray-400">
