<template>
  <div>
    <HeadlessMenu as="div" class="z-50 flex items-center justify-center text-left">
      <HeadlessMenuButton class="text-gray-500 bg-gray-100 border-gray-300 z-0 ml-0 inline-flex h-12 flex-shrink-0 items-center rounded-l-md border-r px-2.5 py-0 text-center text-sm font-medium outline-none hover:bg-gray-200 focus:ring-gray-500 focus:outline-none focus:ring-2 focus:ring-inset">
        <svg aria-hidden="true" class="mr-2 h-3" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <mask id="mask0_12694_49953" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="15" height="12"><rect x="0.5" width="14" height="12" rx="2" fill="white" /></mask>
        ...
        <HeadlessMenuItems class="bg-white ring-black absolute left-0 top-full z-50 mt-2 w-48 rounded-md shadow-lg ring-1 ring-opacity-5 focus:outline-none">
          <div class="bg-white w-full rounded-lg px-0 py-1">
            <HeadlessMenuItem v-slot="{ active }" class="group flex w-full flex-row flex-nowrap items-center justify-start no-underline">
              <button :class="[active ? 'text-gray-900 bg-gray-100 fill-gray-900' : 'text-gray-700 fill-gray-500', 'flex justify-start gap-x-3 px-3 py-2 text-left text-base  ']">
