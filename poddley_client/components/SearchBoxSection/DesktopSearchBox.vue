    ...
    <div class="mx-auto flex-col gap-y-2 py-3 sm:flex sm:pb-5 md:px-5">
        <form class="flex items-center">
            ...
            <div class="relative w-full">
                ...
                <input :autofocus="props.autofocus" type="text" id="voice-search" class="text-gray-900 bg-gray-100 border-gray-200 block w-full rounded-lg border p-2.5 pl-10 text-base focus:border-gray-500 focus:ring-gray-500 text-center" placeholder="Search for podcasts, episodes and quotes from podcasts" required />
                <button type="button" class="group absolute inset-y-0 right-0 flex pr-0 justify-center items-center">
