<template>
  ...
  <div class="bg-gray-100 border-gray-200 mx-auto hidden w-full flex-col items-center justify-center gap-y-2 rounded-md border py-0 sm:flex md:px-0">
    <div class="relative w-full h-10 flex-row sm:flex">
      <input autofocus @input="handleSearch" type="text" id="voice-search" :class="`text-gray-900 bg-gray-100 block w-full ${!searchQuery.searchString ? '' : 'rounded-r-none'} rounded-lg p-2.5 text-center text-base focus:ring-gray-500 focus:outline-none focus:ring-2 focus:ring-inset`" placeholder="Search for podcasts, episodes and quotes from podcasts" />
