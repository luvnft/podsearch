...
=======
  <!-- Mobile Search Bar -->
  <div class="border-gray-400 relative mb-1 mt-1 flex h-12 flex-grow items-center rounded-lg border-[3px] bg-transparent outline-none ring-0 sm:hidden" v-if="props.openSearchSection">
    <input
      type="text"
      name="search"
      id="search"
      placeholder="Search for quotes in podcasts & other"
      class="bg-white text-gray-800 border-gray-300 block h-full w-full justify-center rounded-md pl-2 pr-1 text-center text-base outline-none placeholder:text-neutral-300 focus:border-gray-500 focus:ring-gray-500 dark:placeholder:text-gray-200"
      autofocus
    ...
    <button
      ...
      class="hover:bg-gray-transparent text-gray-400 mr-0 flex aspect-square h-full items-center justify-center rounded-md border-0 p-2 outline-none ring-0 hover:text-gray-500 focus:ring-gray-500 hover:border-none focus:outline-none focus:ring-2 focus:ring-inset"
    >
      <XMarkIcon class="block h-full w-full scale-90 fill-gray-300 group-hover:fill-gray-500" aria-hidden="true" />
    </button>
  </div>
  <!-- Desktop Search Bar-->
  <div class="hidden h-full sm:flex w-full justify-center">
    <div class="mx-auto flex flex-col gap-y-2 py-3 sm:flex sm:pb-5 md:px-1 w-full">
      <form class="flex items-center">
        ...
        <div class="relative w-full">
          ...
          <input
            ...
            placeholder="Search for podcasts, episodes and quotes in podcasts"
            required
          />
