      ...
      <form class="flex items-center">
        ...
        <div class="relative w-full">
          ...
          <input
            type="text"
            id="voice-search"
            class="text-gray-900 bg-gray-50 border-gray-300 block w-full rounded-lg border p-2.5 pl-10 text-base focus:border-gray-500 focus:ring-gray-500 dark:text-white dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:border-gray-500 dark:focus:ring-gray-500"
        ...
        <button
          type="submit"
          class="text-white bg-gray-700 border-gray-700 ml-2 inline-flex items-center rounded-lg border px-3 py-2.5 text-base font-medium hover:bg-gray-800 focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800 focus:outline-none focus:ring-4"
        >
