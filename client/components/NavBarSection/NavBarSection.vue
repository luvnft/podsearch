<template>
    <nav class="container-fluid bg-white z-40 px-0 py-0">
        <div class="mx-auto h-full w-full max-w-screen px-1 lg:px-[20px]">
            ...
            <SearchBoxSection
                class="h-15 flex items-center justify-center focus:ring-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus-visible:outline-none"
                :openSearchSection="openSearchSection" />
        </div>
    </nav>
</template>
